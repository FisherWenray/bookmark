# Bookmark Navigation (书签导航)

一个收录 5000+ 标签/链接的高颜值个人书签导航页，支持快速搜索与折叠分类。
...
```bash
git add index.html raw_bookmarks/
...
* **替换 Logo**：直接替换根目录下的 `logo.png`，或者修改 `generate_nav.py` 模板中有关 logo 的样式。
